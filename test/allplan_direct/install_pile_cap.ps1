...
$pypSource = Join-Path $scriptDir "PileCapTest.pyp"
$pySource = Join-Path $scriptDir "PileCapTest.py"

$pythonPartsDir = Join-Path $AllplanLocal "PythonParts"
$pythonPartsScriptsDir = Join-Path $AllplanLocal "PythonPartsScripts"

$pypTarget = Join-Path $pythonPartsDir "PileCapTest.pyp"
$pyTarget = Join-Path $pythonPartsScriptsDir "PileCapTest.py"
